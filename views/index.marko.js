...
function render(input, out) {
  ...
  out.w("<nav class=\"navbar navbar-inverse\"><div class=\"navbar-header\"><a class=\"navbar-brand\" href=\"#\"> Lista de Carros
  
  </a></div></nav><div class=\"container page-wrap\"><div class=\"row\"> ");

  marko_forEach(data.cars, function(car) {
    out.w("<div class=\"col-md-3 col-sm-6 hero-feature text-center\"><div class=\"thumbnail\"><img src=\"images/" +
      marko_escapeXmlAttr(car.name) +
      "\" alt=\"\"><div class=\"caption\"><h3>" +
      marko_escapeXml(car.model) +
      "</h3><p>" +
      marko_escapeXml(car.color) +
      "</p><p>" );    
  });
